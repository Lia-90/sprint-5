...
func (t Training) meanSpeed() float64 {
	...
	dist := t.distance() / (t.Duration.Hours())
	return dist
}
...
func (w Walking) Calories() float64 {
	...
	return ((CaloriesWeightMultiplier*w.Weight + (math.Pow(speed, 2)/w.Height)*CaloriesSpeedHeightMultiplier*w.Weight) * w.Duration.Hours() * MinInHours)
